...
<kbd><img src="uploads/a803032b3046966eaa8641702a8792cd/step1.png" alt="step1" width=300><br>&nbsp;<br>Fig. 1: Right-click on an element of interest<br> and chose "Query features."<br>&nbsp;</kbd>
<kbd><img src="uploads/c0d0b11e9e08ded89cc279ced74fe2e1/step2.png" alt="step2" width=300><br>&nbsp;<br>Fig. 2: Select an appropriate relation.<br>&nbsp;<br>&nbsp;</kbd>
<kbd><img src="uploads/84f46b46f3783cc585dc345a3253dcc7/step3.png" alt="step3" width=300><br>&nbsp;<br>Fig. 3: Copy the relation ID (here: 4683240).<br>&nbsp;<br>&nbsp;</kbd>
...
<kbd><img src="uploads/7a89aec9429f2739c32d19c0e6868ca2/step4.png" alt="step4" width=300><br>&nbsp;<br>Fig. 4: Query the relation ID. The resulting<br>group must be recursively broken with (._;>;);<br>to be displayed. We want a single path con-<br>necting Wien and Retz. The relation, however,<br>contains additional features, e.g., railway<br>platforms.<br>&nbsp;<br>&nbsp;</kbd>
<kbd><img src="uploads/eba29d8beeb05acfc383d2f4fb687b71/step5.png" alt="step5" width=300><br>&nbsp;<br>Fig. 5: By selecting only way-elements with<br>tag "rail" we remove all unwanted objects.<br><br><br><br><br>&nbsp;<br>&nbsp;</kbd>
<kbd><img src="uploads/5d92762461b3a4dcac49dbd41177fe70/step6.png" alt="step6" width=300><br>&nbsp;<br>Fig. 6: When we are sattisfied with the query,<br>we can export the queried data in .osm format:<br>[exported_railway.osm](uploads/e62647f14d686c52a0d60992fb9813b1/exported_railway.osm).<br><br><br><br>&nbsp;<br>&nbsp;</kbd>
...
With the following osmconvert command, we convert the source file ([exported_railway.osm](uploads/e62647f14d686c52a0d60992fb9813b1/exported_railway.osm)) into a .csv file ([railway.csv](uploads/c9edae502750da1a1176ebbb4dd38ad7/railway.csv)):
```shell
...
<kbd><img src="uploads/4f11d0acd17563cb964d89f0722e5690/path_unordered.png" alt="fig7" width=250><br>&nbsp;<br>Fig. 7: Original, unsorted waypoints<br>([railway.csv](uploads/c9edae502750da1a1176ebbb4dd38ad7/railway.csv)).<br><br></kbd>
<kbd><img src="uploads/673972c5a96bc6689b52def72047b687/path_ordered.png" alt="fig8" width=250><br>&nbsp;<br>Fig. 8: Waypoints after being sorted <br>([railway_sorted.csv](uploads/0432967de244201fb5399a8bbde223f4/railway_sorted.csv)).<br><br></kbd>
